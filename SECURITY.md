...
Only the **latest released version** of `GroupDocs.Conversion.Mcp` (NuGet / GHCR / Docker Hub)
...
- Use GitHub's [private vulnerability reporting](https://github.com/groupdocs-conversion/GroupDocs.Conversion.Mcp/security/advisories/new)
...
- Vulnerabilities in the underlying `GroupDocs.Conversion` engine (a closed-source NuGet
