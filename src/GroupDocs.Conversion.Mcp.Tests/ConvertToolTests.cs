...
public class ConvertToolTests
{
    ...
    [Fact]
    public async Task Convert_WhenResolverThrows_PropagatesException()
    {
        _resolver
    ...
    [Fact]
    public async Task Convert_WhenResolverThrows_DoesNotWriteToStorage()
    {
        _resolver
            .Setup(r => r.ResolveAsync(It.IsAny<FileInput>(), It.IsAny<CancellationToken>()))
            .ThrowsAsync(new FileNotFoundException("missing.docx"));
    ...
    [Fact]
    public async Task Convert_SetsLicense_BeforeResolving()
    {
    ...
    [Fact]
    public async Task Convert_PassesFileInputToResolver_Unchanged()
    {
