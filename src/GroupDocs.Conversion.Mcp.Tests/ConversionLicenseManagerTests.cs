...
using GroupDocs.Conversion.Mcp;
...
public class ConversionLicenseManagerTests
{
    [Fact]
    public void IsLicensed_WithoutLicensePath_ReturnsFalse()
    {
        ...
        var manager = new ConversionLicenseManager(options, NullLogger<LicenseManager>.Instance);
