...
Thanks for your interest in improving the GroupDocs.Conversion MCP server.
...
`.vscode/mcp.json` contains a `groupdocs-conversion-dev` entry that runs the server from
...
Use the [issue templates](https://github.com/groupdocs-conversion/GroupDocs.Conversion.Mcp/issues/new/choose).
